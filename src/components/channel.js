        ...
        <Fragment>
            ...
            <div className="container mt-5">
                <div className="row mt-5">
                    <div className="col-sm-12 col-6 mt-5">
                    ...
                    <div className="col-sm-12 col-6 mt-5">
                        <div className="channel text-center">
                            ...
                            <strong><a target='_blank' rel="noopener noreferrer" href='https://www.youtube.com/channel/UCAUWt7pXZh0bZjB4Z1814YQ' className='black' >Phoenix Gaming</a></strong>
                        </div>
                    </div>
                </div>
            </div>
