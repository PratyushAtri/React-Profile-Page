                ...
                <div className="card">
                    <div className="card-body">
                        ...
                        <div className="btnprojects">
                            ...
                            <a target='_blank' rel="noopener noreferrer" href="https://pratyushatri.github.io/ProfilePage/Projects/Omnifood/website.html" className="btn btn-primary">To the Website</a>
                        </div>
                    </div>
                </div>
                ...
                <div className="card">
                    <div className="card-body">
                        ...
                        <div className="btnprojects">
                            ...
                            <a target='_blank' rel="noopener noreferrer" href="https://pratyushatri.github.io/Calculator/" className="btn btn-primary">Visit</a>
                        </div>
                    </div>
                </div>
